...
class Ad(scrapy.Item):
    ...
    raw_data = scrapy.Field()          # The whole html site
    ...
    characteristics = scrapy.Field()   # Additional information Seesicht, Lift/ Balkon/Sitzplatz
    additional_data = scrapy.Field()   # Data at the moment we do not know where to put
