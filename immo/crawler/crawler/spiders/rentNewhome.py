...
Links:
http://www.newhome.ch/de/mieten/suchen/wohnung/kanton_basellandschaft/liste.aspx?pc=new https://www.newhome.ch/de/mieten/suchen/haus_wohnung/kanton_basellandschaft/liste.aspx?pc=new
...
class RentNewhome(scrapy.Spider):
    """Newhome crawler
    """
    name = "rentNewhome"
    ...
    def start_requests(self):
        """Start method
        """
        urls = ['https://www.newhome.ch/de/mieten/suchen/haus_wohnung/kanton_aargau/liste.aspx?pc=new',
